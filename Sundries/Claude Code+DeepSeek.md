...
## 2.1 终端使用
### 2.1.1 指定文件夹启动
（1）打开文件管理器，去到需要用该模型的的地址![650](assets/Claude%20Code+DeepSeek/file-20260524112741910.png)
如我的项目的所需要的文件存放到了指定的项目文件夹ExamScope下，我只需要打开这个文件夹
（2）在地址栏直接输入cmd，回车，就会到达指定文件夹的终端![](assets/Claude%20Code+DeepSeek/file-20260524113100047.png)
